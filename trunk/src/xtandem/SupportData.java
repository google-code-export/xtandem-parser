...
public class SupportData {
	...
	public SupportData(HashMap map, int spectrumNumber){
		if (map.get("HYPERLABEL" + "_s" + spectrumNumber)!= null) iHyperlabel = map.get("HYPERLABEL" + "_s" + spectrumNumber).toString();
		if (map.get("CONVOLLABEL" + "_s" + spectrumNumber)!= null) iConvolLabel = map.get("CONVOLLABEL" + "_s" + spectrumNumber).toString();
        if (map.get("A_IONLABEL" + "_s" + spectrumNumber)!= null) iA_ionLabel = map.get("A_IONLABEL" + "_s" + spectrumNumber).toString();
		if (map.get("B_IONLABEL" + "_s" + spectrumNumber)!= null) iB_ionLabel = map.get("B_IONLABEL" + "_s" + spectrumNumber).toString();
        if (map.get("C_IONLABEL" + "_s" + spectrumNumber)!= null) iC_ionLabel = map.get("C_IONLABEL" + "_s" + spectrumNumber).toString();
        if (map.get("X_IONLABEL" + "_s" + spectrumNumber)!= null) iX_ionLabel = map.get("X_IONLABEL" + "_s" + spectrumNumber).toString();
		if (map.get("Y_IONLABEL" + "_s" + spectrumNumber)!= null) iY_ionLabel = map.get("Y_IONLABEL" + "_s" + spectrumNumber).toString();
        if (map.get("Z_IONLABEL" + "_s" + spectrumNumber)!= null) iZ_ionLabel = map.get("Z_IONLABEL" + "_s" + spectrumNumber).toString();
		if (map.get("SPECTRUMLABEL" + "_s" + spectrumNumber)!= null) iSpectrumLabel = map.get("SPECTRUMLABEL" + "_s" + spectrumNumber).toString();
		if (map.get("FRAGIONSPECDESC" + "_s" + spectrumNumber)!= null) iFragIonSpectrumDescription = map.get("FRAGIONSPECDESC" + "_s" + spectrumNumber).toString();
		if (map.get("FRAGIONMZ" + "_s" + spectrumNumber)!= null) iFragIonMz = Double.parseDouble(map.get("FRAGIONMZ" + "_s" + spectrumNumber).toString());
		if (map.get("FRAGIONCHARGE" + "_s" + spectrumNumber)!= null) iFragIonCharge = Integer.parseInt(map.get("FRAGIONCHARGE" + "_s" + spectrumNumber).toString());
		if (map.get("HYPER_A0" + "_s" + spectrumNumber)!= null) iHyper_a0 = Double.parseDouble(map.get("HYPER_A0" + "_s" + spectrumNumber).toString());
		if (map.get("HYPER_A1" + "_s" + spectrumNumber)!= null) iHyper_a1 = Double.parseDouble(map.get("HYPER_A1" + "_s" + spectrumNumber).toString());
		if (map.get("XVAL_HYPER" + "_s" + spectrumNumber)!= null) iXValuesHyperscore = splitStringToIntegerList(map.get("XVAL_HYPER" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_HYPER" + "_s" + spectrumNumber)!= null) iYValuesHyperscore = splitStringToIntegerList(map.get("YVAL_HYPER" + "_s" + spectrumNumber).toString());
		if (map.get("XVAL_CONVOL" + "_s" + spectrumNumber)!= null) iXValuesConvolute = splitStringToIntegerList(map.get("XVAL_CONVOL" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_CONVOL" + "_s" + spectrumNumber)!= null) iYValuesConvolute = splitStringToIntegerList(map.get("YVAL_CONVOL" + "_s" + spectrumNumber).toString());
        if (map.get("XVAL_AIONS" + "_s" + spectrumNumber)!= null) iXValuesaIons = splitStringToIntegerList(map.get("XVAL_AIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_AIONS" + "_s" + spectrumNumber)!= null) iYValuesaIons = splitStringToIntegerList(map.get("YVAL_AIONS" + "_s" + spectrumNumber).toString());
        if (map.get("XVAL_BIONS" + "_s" + spectrumNumber)!= null) iXValuesbIons = splitStringToIntegerList(map.get("XVAL_BIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_BIONS" + "_s" + spectrumNumber)!= null) iYValuesbIons = splitStringToIntegerList(map.get("YVAL_BIONS" + "_s" + spectrumNumber).toString());
		if (map.get("XVAL_CIONS" + "_s" + spectrumNumber)!= null) iXValuescIons = splitStringToIntegerList(map.get("XVAL_CIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_CIONS" + "_s" + spectrumNumber)!= null) iYValuescIons = splitStringToIntegerList(map.get("YVAL_CIONS" + "_s" + spectrumNumber).toString());
		if (map.get("XVAL_XIONS" + "_s" + spectrumNumber)!= null) iXValuesxIons = splitStringToIntegerList(map.get("XVAL_XIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_XIONS" + "_s" + spectrumNumber)!= null) iYValuesxIons = splitStringToIntegerList(map.get("YVAL_XIONS" + "_s" + spectrumNumber).toString());
        if (map.get("XVAL_YIONS" + "_s" + spectrumNumber)!= null) iXValuesyIons = splitStringToIntegerList(map.get("XVAL_YIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_YIONS" + "_s" + spectrumNumber)!= null) iYValuesyIons = splitStringToIntegerList(map.get("YVAL_YIONS" + "_s" + spectrumNumber).toString());
        if (map.get("XVAL_ZIONS" + "_s" + spectrumNumber)!= null) iXValueszIons = splitStringToIntegerList(map.get("XVAL_ZIONS" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_ZIONS" + "_s" + spectrumNumber)!= null) iYValueszIons = splitStringToIntegerList(map.get("YVAL_ZIONS" + "_s" + spectrumNumber).toString());
		if (map.get("XVAL_FRAGIONMZ" + "_s" + spectrumNumber)!= null) iXValuesFragIonMass2Charge = splitStringToDoubleList(map.get("XVAL_FRAGIONMZ" + "_s" + spectrumNumber).toString());
		if (map.get("YVAL_FRAGIONMZ" + "_s" + spectrumNumber)!= null) iYValuesFragIonMass2Charge = splitStringToDoubleList(map.get("YVAL_FRAGIONMZ" + "_s" + spectrumNumber).toString());
	}
